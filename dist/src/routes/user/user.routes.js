...
import { userResponseSchema, userProfileResponseSchema, userStatsResponseSchema } from "./user.schema";
const userRoutes = async (fastify) => {
    ...
    fastify.get("/profile", {
        ...
        schema: {
            tags: ["user"],
            security: [{ bearerAuth: [] }],
            summary: "Get current user detailed profile with organizations and tasks",
