...
import getActivityAttendeesRoute from "./routes/activity/[id]/attendees/get";
import joinActivityRoute from "./routes/activity/[id]/join/post";
import leaveActivityRoute from "./routes/activity/[id]/leave/delete";
...
export default async function (app: FastifyInstance) {
  ...
  app.register(getActivityAttendeesRoute);
  app.register(joinActivityRoute);
  app.register(leaveActivityRoute);
