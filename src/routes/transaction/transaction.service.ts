...
export class TransactionService {
  ...
  async createTransaction(
    ...
    return this.prisma.$transaction(async (tx) => {
      ...
      await this.transactionModel.updateAccountBalance(
        data.accountId,
        data.amount,
  ...
  async getTransactions(
    ...
    const { transactions, total, summary } =
      await this.transactionModel.findMany(filters);
  ...
  async updateTransaction(
    ...
    if (data.amount !== undefined || data.transactionType !== undefined) {
      return this.prisma.$transaction(async (tx) => {
        ...
        await this.transactionModel.reverseAccountBalance(
